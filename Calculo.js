...
function tipo1(metros){
    ...
    let cementototal = cemento + (8.4 * 0.5);

    let arena = metros * 0.67;
    let arenatotal = arena + (0.67 * 0.5);

    let grava = metros * 0.67;
    let gravatotal = grava + (0.67 * 0.5);

    let agua = metros * 220;
    let aguatotal = agua + (220 * 0.5);
...
function tipo2(metros){
    ...
    let cementototal = cemento + (7 * 0.5);

    let arena = metros * 0.56;
    let arenatotal = arena + (0.56 * 0.5);

    let grava = metros * 0.84;
    let gravatotal = grava + (0.84 * 0.5);

    let agua = metros * 180;
    let aguatotal = agua + (180 * 0.5);
...
function tipo3(metros){
    ...
    let cementototal = cemento + (6 * 0.5);

    let arena = metros * 0.48;
    let arenatotal = arena + (0.48 * 0.5);

    let grava = metros * 0.96;
    let gravatotal = grava + (0.96 * 0.5);

    let agua = metros * 170;
    let aguatotal = agua + (170 * 0.5);
...
function tipo4(metros){
    ...
    let cementototal = cemento + (5.2 * 0.5);

    let arena = metros * 0.63;
    let arenatotal = arena + (0.63 * 0.5);
...
function tipo5(metros){
    ...
    let cementototal = cemento + (4.2 * 0.5);

    let arena = metros * 0.5;
    let arenatotal = arena + (0.5 * 0.5);

    let grava = metros * 1.0;
    let gravatotal = grava + (1.0 * 0.5);

    let agua = metros * 160;
    let aguatotal = agua + (160 * 0.5);
